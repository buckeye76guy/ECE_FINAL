...
np.save('base_eta1.npy', my_array) # d i.e. not from qsub command
...
my_array = np.hstack((np.matrix(history.losses).T,
                      np.matrix(history.accuracy).T))
np.save('base_eta2.npy', my_array)
...
my_array = np.hstack((np.matrix(history.losses).T,
                      np.matrix(history.accuracy).T))
np.save('lstm3_eta1.npy', my_array)
...
my_array = np.hstack((np.matrix(history.losses).T,
                      np.matrix(history.accuracy).T))
np.save('lstm3_eta2.npy', my_array)
...
my_array = np.hstack((np.matrix(history.losses).T,
                      np.matrix(history.accuracy).T))
np.save('lstm5_eta1.npy', my_array)
...
my_array = np.hstack((np.matrix(history.losses).T,
                      np.matrix(history.accuracy).T))
np.save('lstm5_eta2.npy', my_array)