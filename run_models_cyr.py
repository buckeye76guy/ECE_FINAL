...
X_train = np.load('xtrain_cyr.npy')
max_pix = np.max(X_train)
X_train /= max_pix

X_test = np.load('xtest_cyr.npy')
...
y_train = np.load('ytrain_cyr.npy')
y_test = np.load('ytest_cyr.npy')
...
np.save('cyrResults/base_eta1_d.npy', my_array) # d i.e. not from qsub command
...
my_array = np.hstack((np.matrix(history.losses).T,
                      np.matrix(history.accuracy).T))
np.save('cyrResults/base_eta2_d.npy', my_array)
...
my_array = np.hstack((np.matrix(history.losses).T,
                      np.matrix(history.accuracy).T))
np.save('cyrResults/lstm3_eta1_d.npy', my_array)
...
my_array = np.hstack((np.matrix(history.losses).T,
                      np.matrix(history.accuracy).T))
np.save('cyrResults/lstm3_eta2_d.npy', my_array)
...
my_array = np.hstack((np.matrix(history.losses).T,
                      np.matrix(history.accuracy).T))
np.save('cyrResults/lstm5_eta1_d.npy', my_array)
...
my_array = np.hstack((np.matrix(history.losses).T,
                      np.matrix(history.accuracy).T))
np.save('cyrResults/lstm5_eta2_d.npy', my_array)